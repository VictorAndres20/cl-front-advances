...
import { UpdateEmployeeHook } from "../../../_hooks/employees/useUpdteEmployee.hook";

export default function ChangePasswordForm({ id, updateHook }: { id: string, updateHook: UpdateEmployeeHook }) {
