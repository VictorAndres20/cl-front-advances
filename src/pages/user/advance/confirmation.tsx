...
export default function Confirmation({ hook }: { hook: GenerateAdvacneHook }){
    ...
    return(
        <div style={{ width: '100%', marginTop: '30px' }}>
            <div className="flex-col flex-center" style={{ backgroundColor: '#A6ABB8', width: '100%', padding: '20px 0', borderRadius: '20px', margin: '10px 0' }}>
            ...
            <div className="flex-col flex-center" style={{ backgroundColor: '#A6ABB8', width: '100%', padding: '10px 0', borderRadius: '20px', margin: '10px 0' }}>
                <div>
